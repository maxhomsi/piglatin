...
input.addEventListener('keyup', function(e){
  if (e.keyCode == 13){
    ...
    let result = document.getElementById('resultado') //perguntar como simplficar a funcao
  ...
  resultado.innerText = convertida
    ...
    console.log("apertou")  //tenho que colocar aqui o funcao que executa o codigo executar
  }
